...
```bash
python scripts/run_code_generation.py data/experiment_action.csv --output-folder results/gpt-4o/generated_games/ --model gpt-4o
python scripts/run_code_generation.py data/experiment_distractor.csv --output-folder results/gpt-4o/generated_games/ --model gpt-4o
python scripts/run_code_generation.py data/experiment_object.csv --output-folder results/gpt-4o/generated_games/ --model gpt-4o
```
