...
class TextGame:
    ...
    def sample_task(self, exist_foods):
        ...
        self.target_shutter_speed = self.random.choice(
            self.camera.shutter_speed_dial)
        self.target_iso = self.random.choice(self.camera.iso_dial)

    # Get the task description for this game
    def getTaskDescription(self):
        return "Your task is to take a nice picture of %s, using a camera with shutter speed of %s, aperture of %s, and iso of %s." % (self.target_food, self.target_shutter_speed, self.target_aperture, self.target_iso)
