...
class MilkHeatingGame(TextGame):
    ...
    def generatePossibleActions(self):
        ...
        for objReferent, objs in allObjects.items():
            for obj in objs:
                if isinstance(obj, Pot):
                    self.addAction("put pot on stove", ["put", obj, self.rootObject.contains[2]])  # Fixed index to reference stove correctly
        ...
        if 'milk' in allObjects:  # Ensure milk is in the dictionary before accessing
