...
class SpaceWalkGame(TextGame):
    ...
    def generatePossibleActions(self):
        ...
        # (1-arg) Take, open/close, Move, Put on
    ...
    def step(self, actionStr):
        ...
        actions = {
            ...
            "open": lambda: self.actionOpen(action[1]),  # Open a door
            "close": lambda: self.actionClose(action[1]),  # Close a door
            "wear": lambda: self.actionPutOn(action[1]),  # Put on the space suit
...
if __name__ == "__main__":
    ...
    main(SpaceWalkGame(randomSeed=0))
