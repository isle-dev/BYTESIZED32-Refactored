...
class MultimeterGame(TextGame):
    ...
    def actionConnect(self, obj1, terminal_1, obj2, terminal_2):
        if not (obj1.getProperty("is_wire") or obj2.getProperty("is_wire") or isinstance(obj1,
                                                                                         Multimeter) or isinstance(obj2,
                                                                                                                   Multimeter)):
...
if __name__ == "__main__":
    ...
    main(MultimeterGame(randomSeed=1), args.commands, args.status)
